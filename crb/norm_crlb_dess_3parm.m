  function [F, sig_M0s, sig_T1, sig_T2] = norm_crlb_dess_3parm(T1, T2, wf,...
      flip_spgr, flip_dess, TR_spgr, TR_dess, TE, Sig_inv, time_comp)
% function [F, sig_M0s, sig_T1, sig_T2] = norm_crlb_dess_3parm(T1, T2, wf,...
%     flip_spgr, flip_dess, TR_spgr, TR_dess, TE, Sig_inv, time_comp)
% 
% Inputs: 
...
%   sig_M0s     [1]         Time-compensated CRLB std. dev. for (unity) M0s
...
for a = 1:nf1
    ...
    grad_s(:,a) = ...
        [spgr(1,     E1_spgr, E2_spgr, flip_spgr(a), TR_spgr(a), TE);...
         dspgr_T1(1, E1_spgr, E2_spgr, flip_spgr(a), TR_spgr(a), TE);...
         dspgr_T2(1, E1_spgr, E2_spgr, flip_spgr(a), TR_spgr(a), TE)];
end
...
for a = 1:nf2
    ...
    grad_p(:,a) = ...
        [fp(1,     E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf);...
         dfp_T1(1, E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf);...
         dfp_T2(1, E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf)];
    grad_m(:,a) = ...
        [fm(1,     E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf);...
         dfm_T1(1, E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf);...
         dfm_T2(1, E1_dess, E2_dess, flip_dess(a), TR_dess(a), TE, wf)];
end
