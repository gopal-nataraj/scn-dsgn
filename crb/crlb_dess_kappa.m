  function [F, sig_M0s, sig_T1, sig_T2, sig_kap] = crlb_dess_kappa(M0s, ...
      T1, T2, kap, wf, flip_spgr, flip_dess, TR_spgr, TR_dess, TE, Sig_inv)
% function [F, sig_M0s, sig_T1, sig_T2, sig_kap] = crlb_dess_kappa(M0s, ...
%     T1, T2, kap, wf, flip_spgr, flip_dess, TR_spgr, TR_dess, TE, Sig_inv)
% 
% Matrix Cramer-Rao Bound calculator for unbiased estimator variance.
% This version assumes 4 unknown parameters: M0s, T1, T2, kap.
%
% Inputs: 
...
for a = 1:nf1
    ...
    grad_s(:,a) = ...
        [dspgr_M0s(M0s, E1_spgr, E2_spgr, kap, flip_spgr(a), TR_spgr(a), TE);...
         dspgr_T1(M0s,  E1_spgr, E2_spgr, kap, flip_spgr(a), TR_spgr(a), TE);...
         dspgr_T2(M0s,  E1_spgr, E2_spgr, kap, flip_spgr(a), TR_spgr(a), TE);...
         dspgr_kap(M0s, E1_spgr, E2_spgr, kap, flip_spgr(a), TR_spgr(a), TE)];
end
...
for a = 1:nf2
    ...
    grad_p(:,a) = ...
        [dfp_M0s(M0s, E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfp_T1(M0s,  E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfp_T2(M0s,  E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfp_kap(M0s, E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf)];
    grad_m(:,a) = ...
        [dfm_M0s(M0s, E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfm_T1(M0s,  E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfm_T2(M0s,  E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf);...
         dfm_kap(M0s, E1_dess, E2_dess, kap, flip_dess(a), TR_dess(a), TE, wf)];
end
